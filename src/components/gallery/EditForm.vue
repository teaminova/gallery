<template>
  <form @submit.prevent='submitForm'>
    ...
    <div class='form-control' :class='{invalid: !title.isValid}'>
      ...
      <input type='text' class='text_or_num_input' id='title' v-model.trim='title.val' @blur="clearValidity('title')" />
    ...
    <div class='container'>
      <div class='form-control' :class='{invalid: !price.isValid}'>
        ...
        <input type='number' class='text_or_num_input' id='price' v-model.number='price.val' @blur="clearValidity('price')" />
        <p v-if='!price.isValid'>Please enter a valid price.</p>
      </div>
      <div class='form-control' :class='{invalid: !year.isValid}'>
        <label for='year'>Year: </label>
        <input type='number' class='text_or_num_input' id='year' v-model.number='year.val' @blur="clearValidity('year')" />
        <p v-if='!year.isValid'>Please enter a valid year.</p>
      </div>
      <div class='form-control' :class='{invalid: !width.isValid}'>
        <label for='width'>Width (cm): </label>
        <input type='number' class='text_or_num_input' id='width' v-model.number='width.val' @blur="clearValidity('width')" />
        <p v-if='!width.isValid'>Please enter a valid width.</p>
      </div>
      <div class='form-control' :class='{invalid: !height.isValid}'>
        <label for='height'>Height (cm): </label>
        <input type='number' class='text_or_num_input' id='height' v-model.number='height.val' @blur="clearValidity('height')" />
    ...
    <div class='controls'>
      <base-button mode='outline' type='button' name='cancel' value='cancel' @click='cancelEdit'>Cancel</base-button>
